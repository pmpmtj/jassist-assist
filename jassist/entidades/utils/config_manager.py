"""
Configuration management utilities for entidades processing
...
logger = setup_logger("config_manager", module="entidades")
...
def get_module_dir() -> Path:
    """
    Get the entidades module directory.
    
    Returns:
        Path: Path to the entidades module directory
    """
