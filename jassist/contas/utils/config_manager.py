"""
Configuration management utilities for financial transactions processing
...
logger = setup_logger("config_manager", module="contas")
...
def get_module_dir() -> Path:
    """
    Get the contas module directory.
    
    Returns:
        Path: Path to the contas module directory
    """
