"""
Configuration management utilities for diary processing
...
logger = setup_logger("config_manager", module="diario")
...
def get_module_dir() -> Path:
    """
    Get the diario module directory.
    
    Returns:
        Path: Path to the diario module directory
    """
