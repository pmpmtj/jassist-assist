"""
Configuration management utilities for agenda processing
...
logger = setup_logger("config_manager", module="agenda")
...
def get_module_dir() -> Path:
    """
    Get the agenda module directory.
    
    Returns:
        Path: Path to the agenda module directory
    """
...
def load_agenda_config() -> Dict[str, Any]:
    """
    Load the agenda configuration.
    
    Returns:
        Dict containing the agenda configuration
    """
    return load_json_config("agenda_config.json") 